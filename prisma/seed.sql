...
INSERT INTO public."Faq" (id, category, question, answer, "createdAt") VALUES ('seed-faq-007', 'status', '送信した問い合わせの対応状況はどこで確認できますか。', '「申請一覧」ページで、自社が送信した問い合わせの対応状況（新規・対応中・解決済み）を確認できます。', '2026-07-10 05:02:58.342');
INSERT INTO public."Faq" (id, category, question, answer, "createdAt") VALUES ('seed-faq-008', 'status', '「対応中」から「解決済み」に変わるまでの目安期間はどれくらいですか。', '案件の内容や混雑状況により対応期間は異なるため、一律の目安期間は設けておりません。進捗が気になる場合は、申請一覧の詳細画面をご確認ください。', '2026-07-10 05:02:58.347');
...
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-001-en', 'seed-faq-001', 'en', 'How should I contact the head office?', 'Please submit your inquiry from the "Inquiry" page on the portal, entering the case type, urgency, and details. Inquiries by email or phone are not accepted.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-002-en', 'seed-faq-002', 'en', 'Can I submit multiple cases in a single inquiry?', 'Please include only one case per inquiry. If you have multiple cases, create a separate inquiry for each one.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-003-en', 'seed-faq-003', 'en', 'Will a high-urgency inquiry be handled faster?', 'Urgency is used as a reference for prioritizing responses, but it does not guarantee the order or timing of resolution. For urgent matters, please describe the specific situation in the inquiry text.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-004-en', 'seed-faq-004', 'en', 'What is the "original language" field on the inquiry form for?', 'The "original language" field indicates the language in which the free-text inquiry content was originally written. It is used by the head office for translation and review.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-005-en', 'seed-faq-005', 'en', 'Is there a character limit for the free-text field?', 'Yes, the free-text field has a character limit. Check the remaining character count shown below the field as you type, and summarize your content if it exceeds the limit.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-006-en', 'seed-faq-006', 'en', 'Do I need to enter the company name and country every time?', 'In the current phase, the company name and country must be entered for each inquiry. Incorrect input may delay the response, so please enter this information accurately.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-007-en', 'seed-faq-007', 'en', 'Where can I check the status of an inquiry I submitted?', 'You can check the status of inquiries submitted by your company (New, In Progress, Resolved) on the "Inquiry List" page.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-008-en', 'seed-faq-008', 'en', 'How long does it typically take for a case to move from "In Progress" to "Resolved"?', 'The response time varies depending on the content of the case and current workload, so no uniform estimate is provided. If you are concerned about progress, please check the detail screen on the inquiry list.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-009-en', 'seed-faq-009', 'en', 'What should I do if I have an additional question about an inquiry that is already resolved?', 'There is currently no feature to add a follow-up to a resolved inquiry. If you have additional questions, please submit a new inquiry.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-010-en', 'seed-faq-010', 'en', 'Where can I switch the display language of the portal?', 'You can switch between Japanese and English using the language switcher menu in the header at the top of the screen.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-011-en', 'seed-faq-011', 'en', 'What should I do if I cannot log in to the portal?', 'For login issues, please contact your company''s IT administrator or the contact provided during setup. This cannot be handled through the portal''s inquiry form.');
INSERT INTO public."FaqTranslation" (id, "faqId", locale, question, answer) VALUES ('seed-faq-012-en', 'seed-faq-012', 'en', 'How often is the content of the links list or announcements updated?', 'Links and announcements are updated by the head office as needed. The update frequency varies by content, and no fixed schedule is set.');
