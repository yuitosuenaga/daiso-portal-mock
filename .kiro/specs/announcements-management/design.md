...
|-------------|---------|------------|------------|
| 35.1〜35.3, 35.5 | `en`優先フォールバック | announcement-mapper（resolveAnnouncementContent） | `resolveAnnouncementContent` |
| 35.4 | 通知メール本文のen優先生成 | announcement-notifications | `resolveAnnouncementContent`呼び出し |
| 35.6 | 詳細リンクUIロケールのenフォールバック | announcement-notifications（resolveUiLocale） | — |
| 35.7 | 既存テストの期待値更新 | announcement-service.test, announcement-notifications.test | — |
