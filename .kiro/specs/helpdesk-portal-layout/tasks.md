...
- [ ] 6. ログアウト導線の追加とHelpdeskAppShell開閉ボタンのi18n化
- [ ] 6.1 (P) ログアウト・開閉ボタンの翻訳キーを追加する
...
- [ ] 6.2 申請者側Headerにログアウトコントロールを追加する
...
- [ ] 6.3 (P) ヘルプデスク側HelpdeskHeaderにログアウトコントロールを追加する
...
- [ ] 6.4 (P) HelpdeskAppShellの開閉ボタンのaria-labelをi18n化する
...
- [ ] 6.5 (P) ログアウト・i18n化の多言語表示・動作を確認する
