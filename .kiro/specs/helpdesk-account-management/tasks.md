...
- [x] 33. 申請者アカウントの通知言語（preferredLocale）設定を実装する（2026-07-22 追記）
- [x] 33.1 通知言語の定数・型・バリデーションを追加する
...
- [x] 33.2 サービス層でpreferredLocaleを永続化する
  ...
  - _Depends: 33.1_
- [x] 33.3 フォーム・ページに通知言語プルダウンを追加する
...
- [x] 36. 販社（Company）のCSV一括登録を実装する（2026-07-27 追記 / 要件19）
- [x] 36.1 CSVパース+行検証の純粋関数を実装する
...
- [x] 36.2 サービス層に一括作成・既存コード照会を追加する
  ...
  - _Boundary: CompanyService_
  - _Depends: 36.1_
- [x] 36.3 Server Action `importCompaniesAction` を追加する
...
- [x] 37. 複数販社の一括無効化（所属申請者アカウントの一括無効化）を実装する（2026-07-27 追記 / 要件20）
- [x] 37.1 サービス層に一括無効化と有効ユーザー数集計を追加する
...
- [x] 37.2 Server Action `deactivateCompaniesApplicantUsersAction` を追加する
